...
identityCap = 19; %min number of images in each identity folder
...
if versionCB ==1
    condition = repmat([3,2,1],[1,numel(usedList)/3]);
elseif versionCB ==2
    condition = repmat([2,1,3],[1,numel(usedList)/3]);
elseif versionCB ==3
    condition = repmat([1,3,2],[1,numel(usedList)/3]);
end
